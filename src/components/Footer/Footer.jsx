    ...
    <footer className="bg-theme pt-7 pb-5 bottom-0 left-0 right-0">
      <div className="nike-container text-slate-200">
        <div className="flex gap-8 items-center justify-center text-slate-200">
          <a href="https://github.com/Tarunrajput04" className="cursor-pointer hover:scale-110 transform duration-300 transition-all" rel="noreferrer"  target="_blank">
            <BsGithub className="w-auto h-6" />
          </a>
          <a href="https://www.linkedin.com/in/tarun-kumar-82a124224/" className="cursor-pointer hover:scale-110 transform duration-300 transition-all" rel="noreferrer"  target="_blank">
